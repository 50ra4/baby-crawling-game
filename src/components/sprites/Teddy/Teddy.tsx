...
export function Teddy({ size = 56 }: TeddyProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 60 62" style={SPRITE_STYLE}>
      ...
      <ellipse cx="20" cy="49" rx="10" ry="9" fill={FUR} stroke={FUR_DARK} strokeWidth="2" />
      <ellipse cx="40" cy="49" rx="10" ry="9" fill={FUR} stroke={FUR_DARK} strokeWidth="2" />
      <ellipse cx="20" cy="50" rx="4.5" ry="4" fill={FUR_LIGHT} />
      <ellipse cx="40" cy="50" rx="4.5" ry="4" fill={FUR_LIGHT} />
      <ellipse cx="11" cy="35" rx="7.5" ry="9" fill={FUR} stroke={FUR_DARK} strokeWidth="2" transform="rotate(-18 11 35)" />
      <ellipse cx="49" cy="35" rx="7.5" ry="9" fill={FUR} stroke={FUR_DARK} strokeWidth="2" transform="rotate(18 49 35)" />
      <ellipse cx="30" cy="39" rx="15" ry="14" fill={FUR} stroke={FUR_DARK} strokeWidth="2.2" />
      <ellipse cx="30" cy="41" rx="9" ry="9" fill={FUR_LIGHT} />
      <circle cx="18" cy="11" r="7" fill={FUR} stroke={FUR_DARK} strokeWidth="2" />
      <circle cx="42" cy="11" r="7" fill={FUR} stroke={FUR_DARK} strokeWidth="2" />
      <circle cx="18" cy="11" r="3.2" fill={FUR_LIGHT} />
      <circle cx="42" cy="11" r="3.2" fill={FUR_LIGHT} />
      <circle cx="30" cy="18" r="13" fill={FUR} stroke={FUR_DARK} strokeWidth="2.2" />
