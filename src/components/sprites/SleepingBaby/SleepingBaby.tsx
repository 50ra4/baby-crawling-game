...
export function SleepingBaby({
  ...
  return (
    <svg width={size} height={size * 0.72} viewBox="0 0 240 172" style={SPRITE_STYLE}>
      <defs>
      ...
      <g transform={`translate(0 ${breathe})`}>
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M118 102 Q146 98 158 120" fill="none" stroke={clothShade} strokeWidth="1.6" opacity="0.5" />
        ...
        <g transform="translate(78 100) rotate(-13)">
          ...
          <circle cx="27" cy="5" r="6" fill={skin} stroke={skinShade} strokeWidth="1.4" />
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M4 -16 q9 -1 9 -9" fill="none" stroke={hairDark} strokeWidth="2" strokeLinecap="round" opacity="0.75" />
        ...
        <circle cx="64" cy="90" r="9" fill={skin} stroke={skinShade} strokeWidth="1.4" />
        <circle cx="60" cy="116" r="9" fill={skin} stroke={skinShade} strokeWidth="1.4" />
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M108 137 Q150 127 194 139" fill="none" stroke={clothShade} strokeWidth="1.6" opacity="0.5" />
      </g>
    </svg>
  );
}
