...
agent-os/project-adapter/AGENTS.md, filled in (baby-crawling-game and links)
by the adapt-to-project skill. Kept short by improve-instructions if it
ever drifts or grows.
-->

# baby-crawling-game — Agent Instructions
...
Technology-specific rules also live in `.claude/rules/*.md` (i18n / react /
supabase-admin / tailwind / testing / typescript); consult the relevant one.
...
- コミットメッセージは **Why**（変更理由・背景）を body に記録する。
